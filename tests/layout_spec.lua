...
test("computeBoardLayout shares renderer offset math", function()
  local board = layout.computeBoardLayout(500, 400, 10, 15, 20, 28)
  assert.equal(board.offsetX, 100)
  assert.equal(board.offsetY, 86)
  assert.equal(board.tileSize, 20)
end)
